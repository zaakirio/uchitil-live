...
async fn start_recording<R: Runtime>(
    ...
    log_info!("🔥 CALLED start_recording with session: {:?}", session_name);
    log_info!(
        "📋 Backend received parameters - mic: {:?}, system: {:?}, session: {:?}",
        mic_device_name,
        system_device_name,
        session_name
    );
...
async fn start_recording_with_devices_and_session<R: Runtime>(
    ...
    log_info!("🚀 CALLED start_recording_with_devices_and_session - Mic: {:?}, System: {:?}, Session: {:?}",
