    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600">Enable or disable notifications of start and end of session</p>
          </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        ...
        <p className="text-sm text-gray-600 mb-6">
          View and access where Uchitil Live stores your data
        </p>
        ...
        <div className="mt-4 p-3 bg-uchitil-light-pink rounded-md">
          <p className="text-xs text-uchitil-pink">
